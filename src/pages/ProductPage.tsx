...
export default function ProductPage() {
  ...
  return <>
    ...
    <div className="mobile-pdp-buy"><div><small>{product.brand || 'Veloura Edit'}</small><strong>{formatINR(pricing.selling)}</strong></div><button className="button primary" disabled={soldOut} onClick={() => !soldOut && addToCart(product,size,qty)}>{soldOut ? 'Sold out' : 'Add to bag'}</button></div>
