...
export default function Layout() {
  ...
  return <div className="app-shell">
    ...
    <div className="utility-bar container-wide"><span>India</span><div><Link to="/help/faq"><HelpCircle size={13} /> Help</Link><Link to="/account"><Truck size={13} /> Track order</Link></div></div>
