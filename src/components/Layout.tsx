...
import { ChevronDown, Heart, HelpCircle, Home, Menu, Search, ShoppingBag, Smartphone, Truck, UserRound, X } from 'lucide-react'
...
export default function Layout() {
  ...
  return <div className="app-shell">
    ...
    <nav className="mobile-dock" aria-label="Mobile navigation">
      ...
      <button type="button" onClick={() => setMobileSearchOpen(true)}><Search size={20}/><span>Search</span></button>
